...
class WebPWriter extends ImageWriter {
    ...
    public void write(IIOMetadata streamMetadata, IIOImage image, ImageWriteParam param) throws IOException {
        ...
        if(encodedData == null) {
            throw new NullPointerException("encodedData may not be null, with:" + ri.getWidth() + ",height:" + ri.getHeight() + ",encodeAlpha:" + ri.getColorModel().hasAlpha());
        }
    ...
    private static byte[] extractComponentRGBInt(int aWidth, int aHeight, ComponentSampleModel aSampleModel, DataBufferInt aDataBuffer) {
        ...
        if (bankIndices == null || bankIndices.length < 3) {
            throw new ImageDataException("extractComponentRGBInt bankIndices length error, length:" + bankIndices.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
        ...
        if (bankOffsets == null || bankOffsets.length < 3) {
            throw new ImageDataException("extractComponentRGBInt bankOffsets length error, length:" + bankOffsets.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
    ...
    private static byte[] extractComponentRGBByte(int aWidth, int aHeight, ComponentSampleModel aSampleModel, DataBufferByte aDataBuffer) {
        ...
        if (bankIndices == null || bankIndices.length < 3) {
            throw new ImageDataException("extractComponentRGBByte bankIndices length error, length:" + bankIndices.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
        ...
        int[] bankOffsets = aSampleModel.getBandOffsets();
        if (bankOffsets == null || bankOffsets.length < 3) {
            throw new ImageDataException("extractComponentRGBByte bankOffsets length error, length:" + bankOffsets.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
    ...
    private static byte[] extractComponentRGBAInt(int aWidth, int aHeight, ComponentSampleModel aSampleModel, DataBufferInt aDataBuffer) {
        ...
        if (bankIndices == null || bankIndices.length < 4) {
            throw new ImageDataException("extractComponentRGBAInt bankIndices length error, length:" + bankIndices.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
        ...
        int[] bankOffsets = aSampleModel.getBandOffsets();
        if (bankOffsets == null || bankOffsets.length < 4) {
            throw new ImageDataException("extractComponentRGBAInt bankOffsets length error, length:" + bankOffsets.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
    ...
    private static byte[] extractComponentRGBAByte(int aWidth, int aHeight, ComponentSampleModel aSampleModel, DataBufferByte aDataBuffer) {
        ...
        int[] bankIndices = aSampleModel.getBankIndices();
        if (bankIndices == null || bankIndices.length < 4) {
            throw new ImageDataException("extractComponentRGBAByte bankIndices length error, length:" + bankIndices.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
        ...
        int[] bankOffsets = aSampleModel.getBandOffsets();
        if (bankOffsets == null || bankOffsets.length < 4) {
            throw new ImageDataException("extractComponentRGBAByte bankOffsets length error, length:" + bankOffsets.length + ",aWidth:" + aWidth + ",aHeight:" + aHeight);
        }
